...
/**
 * Capabilities for local_grades.
 *
 * Defines local/grades:setessaygrade, a narrow capability that grants
 * only the ability to call the local_grades_set_essay_grade web service
