...
class set_essay_grade extends external_api {
    ...
    public static function execute(int $attemptid, int $slot, float $grade,
        ...
        try {
            ...
            throw new moodle_exception('invalidattemptid', 'local_grades', '', null, $e->getMessage());
        }
        ...
        //
        // We check local/grades:setessaygrade rather than mod/quiz:grade
        ...
        require_capability('local/grades:setessaygrade', $context);
